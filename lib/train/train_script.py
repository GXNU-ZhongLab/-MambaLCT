...
from lib.models.mambalct import build_mambalct


from lib.train.actors import MambaLCTActor
# for import modules
import importlib
...
def run(settings):
    ...
    # Create network
    if settings.script_name == "mambalct":
        net = build_mambalct(cfg)
    else:
    ...
    if settings.script_name == "mambalct":
        ...
        actor = MambaLCTActor(net=net, objective=objective, loss_weight=loss_weight, settings=settings, cfg=cfg)
    else:
        raise ValueError("illegal script name")
