...
def local_env_settings():
    ...
    settings.network_path = '/home/local_data/lxh/history_work/MambaLCT/output/test/networks'    # Where tracking networks are stored.
    settings.nfs_path = '/home/local_data/benchmark/nfs'
    settings.otb_path = '/home/local_data/benchmark/otb'
    settings.prj_dir = '/home/local_data/lxh/history_work/MambaLCT'
    settings.result_plot_path = '/home/local_data/lxh/history_work/MambaLCT/output/test/result_plots'
    settings.results_path = '/home/local_data/lxh/history_work/MambaLCT/output/test/tracking_results'    # Where to store tracking results
    settings.save_dir = '/home/local_data/lxh/history_work/MambaLCT/output'
    settings.segmentation_path = '/home/local_data/lxh/history_work/MambaLCT/output/test/segmentation_results'
